...
private:
    ...
    FInputAxisBinding *forward_binding_, *backward_binding_, *yaw_binding_, *pitch_binding_, *left_yaw_binding_, *up_pitch_binding_;
    ...
    FInputAxisKeyMapping forward_mapping_, backward_mapping_, yaw_mapping_, pitch_mapping_, left_yaw_mapping_, up_pitch_mapping_;
	...
	void setMouseLookMode(bool on);
	bool isShiftKeyDown();
	float speedMultiplier();
	float shift_key_speed_multiplier_ = 10.f;
};