...
public:
	...
	msr::airlib::LidarData getLastFullLidarScan(const std::string& lidar_name = "", const std::string& vehicle_name = "") const;
	...
	vector<int> simGetLastFullLidarScanSegmentation(const std::string& lidar_name = "", const std::string& vehicle_name = "") const;
